...
Figure \@ref(fig:resultfigure1) shows a scatterplot figure produced by one of the R scripts.

```{r resultfigure1,  fig.cap='Scatterplot 1: Weight vs. Height', echo=FALSE}
knitr::include_graphics("../../results/resultfigure_scatter1.png")  


```


```{r resultfigure2,  fig.cap='Scatterplot 2: BMI vs. Weight', echo=FALSE}
knitr::include_graphics("../../results/resultfigure_scatter2.png")  


```


```{r resultfigure3,  fig.cap='Boxplot: Heights', echo=FALSE}
knitr::include_graphics("../../results/resultfigure_boxplot.png")
```
